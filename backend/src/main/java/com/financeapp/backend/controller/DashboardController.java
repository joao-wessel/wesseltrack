...
public class DashboardController {
    ...
    public DashboardSummaryResponse payCreditCardBill(@RequestParam @DateTimeFormat(pattern = "yyyy-MM") YearMonth month) {
        return dashboardService.payDueStatement(month);
    }
}
